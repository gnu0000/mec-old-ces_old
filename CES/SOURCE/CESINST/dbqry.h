...
extern FILE *DbInit (PSZ pszLogFile, PSZ pszServer, PSZ pszDatabase, PSZ pszSA, PSZ pszPassword);
extern void DbDeInit (void);
 ...
 * formatting which has yet to be implemented
 */
extern BOOL DbExecSQLStatement (PSZ pszStatement);


extern BOOL DbSendQueryPart (PSZ pszPart, USHORT *puState);

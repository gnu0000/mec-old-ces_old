...
extern BOOL EXPORT ItiDllInitialize (void);
...
extern DOUBLE CalcReg (PSZ     pszBaseDate,
                       PSZ     pszImportDate,
                       DOUBLE  dBasePrice,
                       DOUBLE  dQuantity,
...
extern DOUBLE GetAdjustment (HHEAP   hheap,
                             PSZ     pszImportDate,
                             PSZ     pszStandardItemKey,
...
extern PSZ CalculateRegression (HHEAP  hheap, 
                                PSZ    pszJobKey,
                                PSZ    pszWorkType, 
                                PSZ    pszStandardItemKey,
                                PSZ    pszBaseDate,

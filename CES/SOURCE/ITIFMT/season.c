 ...
 * 
 * This file provides the Season format method.
 */
...
USHORT EXPORT FmtSeason (PSZ     pszSource,
                         PSZ     pszDest,
                         USHORT  usDestMax,
                         PSZ     pszFormatInfo,
   ...
   if (!ItiFmtQueryEnumString (ENUM_SEASON, usValue,
...
USHORT EXPORT CheckSeason (PSZ     pszSource,
                           PSZ     pszDest,
                           USHORT  usDestMax,
                           PSZ     pszFormatInfo,
                           PUSHORT pusDestLength)
   ...
   if (!ItiFmtCheckEnumValue (ENUM_SEASON, pszSource, &usValue))
      return ITIFMT_BAD_DATA;

...
//   HWND        hwnd;             /* root of broadcast tree          */
 ...
 *| ITIDB_HWND      | 0       |        hwnd     | root of broadcast tree  |
...
extern PSZ *EXPORT ItiDbGetRow1 (HHEAP     hheap, 
                                 PSZ       pszQuery,
                                 PUSHORT   pusNumCols);


extern PSZ EXPORT ItiDbGetRow1Col1 (HHEAP     hheap, 
                                    PSZ       pszQuery);
 ...
 * uNumReads and uNumWrites define the number of connections
 *    to use in this process.
 */

extern BOOL EXPORT ItiDbInit (USHORT uNumConnections);

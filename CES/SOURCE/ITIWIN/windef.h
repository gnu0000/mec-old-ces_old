...
#if !defined (SWDEF_INCLUDED)
#define SWDEF_INCLUDED


WNDPROC ItiWndDefWndProc (HWND hwnd, USHORT umsg, MPARAM mp1, MPARAM mp2);
//int ItiWndDefListWndTxtProc (HWND hwnd, USHORT uRow, USHORT uCol, PSZ pszTxt)

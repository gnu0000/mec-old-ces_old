...
char szAppName [] = "BAMS/DSS Item Browser";
...
BOOL RegisterWindows (void)
   {
   if (ItiMbRegisterStaticWnd (ItemBrowserResultsS, ItemBrowserResultsSProc, 0))
      return FALSE;

   if (ItiMbRegisterListWnd (IBWorkTypeL, ItiWndDefListWndTxtProc, 0))
      return FALSE;

   if (ItiMbRegisterListWnd (IBRoadTypeL, ItiWndDefListWndTxtProc, 0))
      return FALSE;

   if (ItiMbRegisterListWnd (IBDistrictsL, ItiWndDefListWndTxtProc, 0))
      return FALSE;

   if (ItiMbRegisterListWnd (ItemBrowserResultsL, ItiWndDefListWndTxtProc, 0))
      return FALSE;

   if (ItiMbRegisterDialogWnd  (IDD_ITEM_BROWSER, IDD_ITEM_BROWSER, ItemBrowserProc, 0))
      return FALSE;
   return TRUE;
   }

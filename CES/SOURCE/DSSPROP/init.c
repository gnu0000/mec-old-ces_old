 ...
 * Mark Hampton
 *
 * Proposal Browser initialization code
 */
...
char szAppName [] = "BAMS/DSS Proposal Browser";
...
void Initialize (void)
   ...
   pglobals = ItiGlobInitGlobals (habMainThread, hmqMainThread, 
                                  HWND_DESKTOP, HWND_DESKTOP, szAppName, "DSSProp",
                                  VERSION_STRING);
...
BOOL RegisterWindows (void)
   {
   if (ItiMbRegisterStaticWnd (PropBrowserResultsS, PropBrowserResultsSProc, 0))
      return FALSE;

   if (ItiMbRegisterListWnd (PropBrowserResultsL, ItiWndDefListWndTxtProc, 0))
      return FALSE;

   if (ItiMbRegisterDialogWnd (PropBrowserD, PropBrowserD, PropBrowserDProc, 0))
      return FALSE;

   if (ItiMbRegisterListWnd (PropBrowserWorkL, ItiWndDefListWndTxtProc, 0))
      return FALSE;

   if (ItiMbRegisterListWnd (PropBrowserRoadL, ItiWndDefListWndTxtProc, 0))
      return FALSE;

   if (ItiMbRegisterListWnd (PropBrowserDistrictL, ItiWndDefListWndTxtProc, 0))
      return FALSE;

   if (ItiMbRegisterListWnd (PropBrowserBidderL, ItiWndDefListWndTxtProc, 0))
      return FALSE;

...
HLOGIN DbLogin (PSZ  pszAppName,
   ...
   if (FAIL == dbsetlogintime (5))
      {
      ItiErrDisplayHardError ("Inside DbLogin, FAILED. This shouldn't have happened.\n");
...
HDB EXPORT DbOpen (HLOGIN hlogin, PSZ pszServer, PSZ pszDatabase)
   {
   HDB   hdb;

//ItiErrDisplayHardError ("Inside DbOpen, about to dbopen connect to the SQL Server.\n");
...
//ItiErrDisplayHardError ("Inside DbOpen, about to dbuse database.\n");

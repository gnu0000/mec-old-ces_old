...
static BOOL EXPORT InitConnection (PSZ pszServer, PSZ pszDatabase, HLOGIN hlogin)
   {
   HDB   hdb;
//ItiErrDisplayHardError ("About to DbOpen.\n");
...
//ItiErrDisplayHardError ("About to init Qry.\n");
